...
object GDriveHelper {
    ...
    suspend fun fetchAllAudioFiles(
        ...
        scanFolderRecursive(folderId, apiKey, authHeader, result)
        return result
    }
    ...
    private suspend fun scanFolderRecursive(
        ...
        // 1. Fetch all files inside folderId
        ...
        try {
            ...
            for (file in response.files) {
                if (file.mimeType == "application/vnd.google-apps.folder") {
                    ...
                    scanFolderRecursive(file.id, apiKey, authHeader, outFiles)
                           ...
                           file.mimeType == "video/x-matroska" || // Accept MKV/MP4 files as audio sources if needed
